...
def parse_arguments(argv):
    ...
    parser.add_argument('--label_file', type=str,
                        help='标签文件', default='model/labels_363.txt')
    parser.add_argument('--model_file', type=str,
                        help='模型文件(proto)', default='model/inception_resnet_v2_behaviour_363_9_13_518k_split.pb')
    ...
    parser.add_argument('--save_path', type=str,
                        help='结果保存路径', default='behaviour_365_9_13_518k')
